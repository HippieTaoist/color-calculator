...
console.log('Color Destruction | Construction');
console.log('Type the name of a color to break apart.')
console.log('   Purple  |  Ornage  |  Green   ')
console.log('');
console.log('Pick a couple colors to mix together');
